...
class ChefTest < ActiveSupport::TestCase
  ...
  def setup
    @chef = Chef.new(chefname: "levi", email: "levi@example.com",
  ...
  test "email should accept correct format" do
    valid_emails = %w[user@example.com LEVI@gmail.com L.first@yahoo.ca patty+levi@co.uk.org]
  ...
  test "should reject invalid email addresses" do
    invalid_emails = %w[levi@example levi@example,com levi.name@gmail. patty@bar+foo.com]
